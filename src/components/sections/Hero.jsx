  ...
  return (
    <section className="flex flex-col justify-center items-start h-screen p-8 bg-[#EAE1DC]">
      ...
      <p className="text-gray-600 max-w-xl mb-8">
        I'm a passionate developer specializing in building modern web applications and SAAS Application. Currently exploring new opportunities and exciting tech projects.
      </p>
